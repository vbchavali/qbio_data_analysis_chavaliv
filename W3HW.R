...
dim(hr3)
print (hr3)
plot(baseball$HR, baseball$yearID)
laa = baseball[baseball$teamID == "LAA",]
plot(laa$HR, laa$yearID)
atl = baseball[baseball$teamID == "ATL",]
pit = baseball[baseball$teamID == "PIT",]
##1.4.5 I could not figure this one out. Having troubles with grouping three 
##selections at once. Tried pit = baseball[baseball$teamID == "LAA" | "ATL" |
##PIT",] and it did not work. 
